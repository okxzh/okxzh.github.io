...
<a class="register-button" href="https://gwoyicn.biz/join/CNOFF">欧易中文官网</a>
...
1. **访问官网**：<a class="register-button" href="https://gwoyicn.biz/join/CNOFF">欧易中文官网</a>。  
2. **点击注册**：选择手机号或邮箱进行注册。  
3. **完成验证**：输入验证码并设置账户密码。  
...
**官网地址**： <a class="register-button" href="https://gwoyicn.biz/join/CNOFF">欧易中文官网</a>
